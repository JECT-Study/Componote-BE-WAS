...
public record CommentFindByMemberResponse(Long id, @JsonInclude(JsonInclude.Include.NON_NULL) Long parentId, String componentTitle, @JsonInclude(JsonInclude.Include.NON_NULL) String parentContent, String content, LocalDateTime createdAt, boolean isReply) {
    public static CommentFindByMemberResponse from(final CommentFindByMemberDao commentFindByMemberDao) {
        return new CommentFindByMemberResponse(
                ...
                commentFindByMemberDao.parentId(),
                commentFindByMemberDao.componentTitle(),
                commentFindByMemberDao.parentContent().getValue(),
