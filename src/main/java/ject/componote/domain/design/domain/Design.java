...
public class Design extends BaseEntity {
    ...
    public static Design of(final String name, final String organization, final String description, final BaseImage thumbnail, final Long recommendation) {
        return new Design(DesignSummary.of(name, organization, description, thumbnail, recommendation));
    }
}
